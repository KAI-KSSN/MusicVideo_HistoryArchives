# 2020s group resolved-work award audit
...
## Newly registered exact results

- Kendrick Lamar — Count Me Out: UKMVA 2023, Best Hip Hop / Grime / Rap Video — International, Shortlisted.
...
- Similar-title results, including unrelated works named `Someday`, `Fly`, or `バク`, were rejected.

## No additional result registered

No additional exact work-level result was safe to register for `LUMBERJACK`, `Fly with me`, `Fly`, or `バク`. Their empty award arrays are valid completed outcomes.
