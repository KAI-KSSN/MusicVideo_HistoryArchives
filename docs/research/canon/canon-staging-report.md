...
| The Weeknd — Take My Breath | 2020s-01.json | `vfx_credit_unverified`<br>`runtime_unverified` | 1 | 2 | Complete | No |
| Tyler, The Creator — LUMBERJACK | 2020s-02.json | `production_credit_unverified`<br>`vfx_credit_unverified`<br>`runtime_unverified` | 0 | 1 | Complete | No |
...
| Kendrick Lamar — Count Me Out | 2020s-01.json | `production_credit_unverified`<br>`vfx_credit_unverified`<br>`runtime_unverified` | 2 | 3 | Complete | No |
| NewJeans — Ditto | 2020s-01.json | `vfx_credit_unverified`<br>`runtime_unverified`<br>`label_source_needs_upgrade` | 1 | 3 | Complete | No |
| Pharrell Williams — Cash In Cash Out | 2020s-04.json | `official_video_unresolved`<br>`runtime_unverified` | 8 | 7 | Complete | No |
| Doja Cat — Paint The Town Red | 2020s-02.json | `runtime_unverified`<br>`production_source_needs_upgrade` | 2 | 5 | Complete | No |
| SKIIFALL — 2 Charming | 2020s-05.json | `official_video_unresolved`<br>`runtime_unverified`<br>`country_unverified` | 2 | 5 | Complete | No |
