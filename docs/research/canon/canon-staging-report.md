...
| Weval — Someday | 2020s-03.json | `youtube_url_unverified`<br>`award_scope_incomplete`<br>`runtime_unverified`<br>`production_company_unverified` | 1 | 2 | Complete | No |
| millennium parade — Fly with me | 2020s-03.json | `award_scope_incomplete`<br>`runtime_unverified`<br>`label_unverified` | 0 | 2 | Complete | No |
...
| Pharrell Williams — Cash In Cash Out | 2020s-04.json | `official_video_unresolved`<br>`award_scope_incomplete`<br>`runtime_unverified` | 2 | 3 | Complete | No |
| Doja Cat — Paint The Town Red | 2020s-02.json | `award_scope_incomplete`<br>`runtime_unverified`<br>`production_source_needs_upgrade` | 2 | 5 | Complete | No |
| SKIIFALL — 2 Charming | 2020s-05.json | `official_video_unresolved`<br>`award_scope_incomplete`<br>`runtime_unverified`<br>`country_unverified` | 2 | 5 | Complete | No |
| YOASOBI — アイドル | 2020s-02.json | `director_unverified`<br>`production_credit_unverified`<br>`vfx_credit_unverified`<br>`award_scope_incomplete`<br>`runtime_unverified` | 1 | 2 | Complete | No |
| A$AP Rocky — Tailor Swif | 2020s-04.json | `official_video_unresolved`<br>`award_scope_incomplete`<br>`runtime_unverified` | 3 | 4 | Complete | No |
